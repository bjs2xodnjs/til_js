...
- 일반적으로 css와 html 을 제어하는 것이 js 의 목적이다.
- `웹브라우저가 css와 html 을 모두 읽고 난 후의 자리` 모든 재료가 준비되면 오류가 안난다.
- 웹브라우저는 한 줄씩 읽는다.
...
### 1.5. 참조형 데이터 종류 (Referance Data Type)
